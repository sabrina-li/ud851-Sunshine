...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        String perferedLocation = SunshinePreferences.getPreferredWeatherLocation(this);
        URL url = NetworkUtils.buildUrl(perferedLocation);
        WeatherQueryTask weatherQeury = new WeatherQueryTask();
        weatherQeury.execute(url);
    }
    ...
    class WeatherQueryTask extends AsyncTask<URL,Void,String[]>{
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try{
                String weatherStringResult = NetworkUtils.getResponseFromHttpUrl(url);
                weatherResult = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,weatherStringResult);
